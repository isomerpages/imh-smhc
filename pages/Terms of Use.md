...
3A.4. GovTech shall be entitled, but not obliged, to act upon or rely on any instructions, information, transmissions of data, or communications received from the account or use of the Service in relation to your authentication credentials, as if such instructions, information, data or communications were issued by you, whether or not the same was authorised by you.
...
b. This Service is a static website builder tool for the Permitted Entities (listed in sub-paragraph (a) above) to build their own static informational websites and host websites built using the tool. GovTech will operate, develop and maintain until it determines to cease doing so in accordance with the Terms of Use.

c. The Service requires the Permitted Entity to have its own Github account, and the code for the website built will be made available to the public via a Github repository. The Permitted Entity accepts that the licence terms stipulated by GovTech applying to the contents of the Github repository will apply to the Permitted Entity as well as any other person who may access the Github repository. For the avoidance of doubt: (i) the Permitted Entity accepts that such other persons will hence also have a licence to the said contents and (ii) the terms of that licence will supersede anything to the contrary in the Terms of Use or Privacy Statement, only to the extent the licence applies to the contents of the Github repository. If the Permitted Entity does not agree to the licence terms to such contents as may be amended by GovTech from time to time, the Permitted Entity shall cease use of the Service and all rights of the Permitted Entity to the Service and the website built or hosted by the Service shall terminate.

d. The Terms of Use and Privacy Statement does not vest in the Permitted Entity any intellectual property created or licensed by GovTech.

e. Domain maintenance and custom SSL certificate maintenance issues are the Permitted Entity's sole responsibility. GovTech is not responsible for such issues.

f. Please note that GovTech may collect, store and/or process data relating to the websites created by the Service.

g. You are responsible for:

*   i. the management of users editing the content of the website. For this purpose, you and your site owners or administrators shall also be responsible for adding/removing users as and when necessary. For the avoidance of doubt, such users include any external vendors engaged by you to manage the website;
    

*   ii. ensuring that users manage their user accounts appropriately (e.g. not distributing passwords or OTP to unauthorized personnel);
    

*   iii. ensuring that the content published in the website is unclassified and meant to be distributed to the public, and for compliance with any other applicable laws, rules or regulations (such as any Government Instruction Manuals);
    

*   iv. obtaining and maintaining (including, where applicable, renewal, security and configuration of) the domain name of the website, DNS service, and SSL certificates except where otherwise agreed with GovTech;
    

*   v. the acts and omissions of any person you request to be allowed as a user of, or authorizes to use, the Service and the content such person causes to publish. GovTech will not be liable for such acts, omissions, or content;
    

*   vi. any issues concerning the website you create, the content you share on your website and dealing with the site visitors or any other person concerning your website, including without limitation the use, linking, or publication of your own terms and/or privacy policy/statement applying to the website. GovTech is not responsible for your compliance with the applicable rules or laws, or for any failure by you to provide terms or a privacy policy/statement. You are responsible for publishing your own terms of use and privacy policy/statement.
    

h. You may terminate the Terms of Use by giving GovTech one month’s written notice. On termination by either Party, you will have 5 working days to download a copy of the Github repository, following which GovTech may at its sole and absolute discretion delete or archive the contents. If you request to take over the Github repository, GovTech may at its sole and absolute discretion attempt to negotiate the handover of the Github repository to the Permitted Entity. Please note that the handover requires the agreement of Github and hence may not be successful.
...
*   b. KeyCDN’s terms of service ([link](https://www.keycdn.com/terms))
    

*   c. Netlify’s terms of use ([link](https://www.netlify.com/legal/terms-of-use/))
    

*   d. AWS’s service terms ([link](https://aws.amazon.com/service-terms/))
